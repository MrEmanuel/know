Your AI agent is an expert savant coder on speed, with ADHD… suffering from severe amnesia.

Know introduces Active Memory for software.

Software has source code, tests, static documentation, and version control. But it has no memory.
